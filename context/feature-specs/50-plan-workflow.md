...
- **Build:** Wire authenticated `POST /recommendation-runs` and `GET /recommendation-runs/{runId}` through context assembly, eligibility,  BN, DDI, synthesis, persistence, and idempotent status transitions.
