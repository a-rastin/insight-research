...
Decision point / existing evidence: Pharmacotherapy; canonical BN Manager XML and BNs/Pharmacotherapy/Guideline-Pharmacotherapy.txt	


Required implementation: Reconcile source-to-node mappings, hard gates, candidate evaluation semantics, calibration label, golden cases, version/hash