...
* **Build:** Implement server-side page-context projection, identifier omission/scrubbing, provider adapter, advisory response route, bounded UI rail, access/retention controls, and provider-failure state.
