...
- **Build:** Expose admin routes and a bounded UI for model inventory, validation evidence, source/provenance, hashes, lifecycle status, review, activation, retirement, and rollback. Operate only on manifest-owned artifacts.
