...
### INS-061 — Complete system accessibility, and failure-mode verification

- **Build:** Execute threat-model controls, PHI/secret scans, cookie/TLS/header/CSRF/rate-limit/session-revocation tests, log redaction, accessibility audit, reduced motion, and dependency-chaos scenarios.
