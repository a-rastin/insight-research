...
- **Blocked by:** INS-001
- **Build:** Resolve DG-02 and DG-08: formularies, dose/contraindication/monitoring sources, diagnosis terminology, medication terminology, and update cadence.
- **Tests:** Source-manifest schema.