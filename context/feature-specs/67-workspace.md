...
- **Build:**  Upgrade Dashboard to the Authentication UUID session contract, preserve disclaimer and password gates, render available, unavailable, and unauthorized destinations explicitly.
