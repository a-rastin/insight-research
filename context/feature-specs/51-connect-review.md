...
- **Build:** Replace `frontend/src/main.tsx` synthetic plan/finding data with API loading; implement explicit loading/partial/error states, plan read, provenance display, structured edits with `If-Match`.
